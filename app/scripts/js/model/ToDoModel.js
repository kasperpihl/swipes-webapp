    ...
    return BaseModel.extend({
      ...
      addNewSubtask: function(title, from) {
        ...
        if (from) {
          ...
          swipy.analytics.sendEventToIntercom("Added Action Step", {
            "From": "Input",
            "Length": title.length
          });
        }
      ...
      toJSON: function() {
        ...
        clonedAttributes = _.clone(this.attributes);
      ...
      togglePriority: function() {
        ...
        return swipy.analytics.sendEventToIntercom("Update Priority", {
          "Assigned": priorityLabel
        });
      },
      ...
      setRepeatOption: function(repeatOption) {
        ...
        return swipy.analytics.sendEventToIntercom("Recurring Task", {
          "Reoccurrence": repeatOption
        });
      },
