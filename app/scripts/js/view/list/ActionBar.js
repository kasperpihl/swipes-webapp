    ...
    return Backbone.View.extend({
      ...
      deleteTasks: function() {
        ...
        if (confirm("Delete " + selectedTasks.length + " tasks?")) {
          ...
          return swipy.analytics.sendEventToIntercom("Deleted Tasks", {
            "Number of Tasks": selectedTasks.length
          });
        }
      },
      shareTasks: function() {
        ...
        return swipy.analytics.sendEventToIntercom("Share Task Opened", {
          "Number of Tasks": selectedTasks.length
        });
      }
    });
