(function() {
  define(["underscore", "backbone", "js/view/Overlay", "text!templates/settings-overlay.html", "js/view/settings/BaseSubview", "js/view/settings/Faq", "js/view/settings/Policies", "js/view/settings/Snoozes", "js/view/settings/Subscription", "js/view/settings/Support"], function(_, Backbone, Overlay, SettingsOverlayTmpl) {
    return Overlay.extend({
      ...
      showSubview: function(subView) {
        ...
        return this.killSubView().then(function() {
          ...
          return require(["js/view/settings/" + viewName], function(View) {
