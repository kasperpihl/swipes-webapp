(function() {
  define(["underscore", "backbone", "js/view/Overlay", "text!templates/schedule-overlay.html"], function(_, Backbone, Overlay, ScheduleOverlayTmpl) {
    return Overlay.extend({
      ...
      showDatePicker: function() {
        ...
        if (this.datePicker == null) {
          require(["js/view/modules/DatePicker"], function(DatePicker) {
